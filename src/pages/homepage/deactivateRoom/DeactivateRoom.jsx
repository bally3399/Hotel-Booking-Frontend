...
import styles from "./DeactivateRoomById.module.css";
...
const DeactivateRoomByHotelIdPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`${API_URL}/api/v1/admin/hotel/${formData.hotelId}/deactivate/${formData.roomId}`, {
                method: "PATCH",
                headers: { Authorization: `Bearer ${token}` },
            });
            if (response.status === 200) {
                setMessage("Room deactivated successfully!");
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className={styles.submitButtonWrapper}>
                        <Button
                            ...
                            disabled={loading}
                        >
                            {loading ? "Deactivating..." : "Deactivate Room"}
                        </Button>
                    </div>
                </form>
            </div>
