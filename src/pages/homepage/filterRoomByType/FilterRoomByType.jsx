...
const FilterRoomByTypePage = () => {
    const navigate = useNavigate();
    const [formData, setFormData] = useState({ hotelId: "", type: "" });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(
                `${API_URL}/api/v1/admin/hotel/${formData.hotelId}/type/${formData.type}`,
...
export default FilterRoomByTypePage;