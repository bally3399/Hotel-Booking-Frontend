...
const UserBookedRoom = () => {
    const [bookedRooms, setBookedRooms] = useState([]); // Stores the final room details
    ...
    useEffect(() => {
        const fetchBookedRooms = async () => {
            try {
                ...
                const bookedRoomData = response.data.data;


                if (Array.isArray(bookedRoomData)) {

                    const roomDetailsPromises = bookedRoomData.map(async (booking) => {
                    ...
                    const validRoomDetails = roomDetails.filter((room) => room !== null);

                    setBookedRooms(validRoomDetails);
                } else {
