...
import styles from "../deleteHotelById/DeleteHotelById.module.css";
import { HiArrowLeft } from "react-icons/hi";

const API_URL = "https://hotel-booking-management-backend.onrender.com";

const DeleteRoomByIdPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`${API_URL}/api/v1/admin/${formData.roomId}`, {
                method: "DELETE",
...
export default DeleteRoomByIdPage;